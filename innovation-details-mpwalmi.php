...
$aid = $_GET['id'];
 $query ="SELECT * FROM `innovation` WHERE `inno_id` = '".$aid."'" ;
//  echo $query;
...
<head>
    ...
    <title>Innovation-Details - M.P. Water and Land Management Institute, Bhopal</title>
    ...
    <div class="main-container">
        ...
        <div class="why-chose-us ">
            ...
            <div class="single-post-page blog-post-page module ">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-8 col-padding-y grey-bg-color">
                            <div class="single-post single-post-no-bg">
                                <div class="img-thumbnail">
                                    <img src="admin/innovation/<?= $a['image'] ?>" alt="<?= $a['title'] ?>" >
                                </div>
                                <div class="single-blog-text">
                                    <h5><a href="innovation-details-mpwalmi.php?id=<?= $a['inno_id'] ?>"><?= substr($a['title'],0,45); ?></a></h5>
                                    <p><?= $a['description'] ?></p>
                            ...
                            <div class="widget side-bar border-btm">
                                <div class="content widget-popular-posts">
                                    <h6>WALMI</h6>
                                     <?php
                  $i=0;
                  $c=mysqli_query($con,"SELECT * FROM `innovation`");
                  while($a=mysqli_fetch_array($c))
				  {
				          ?>
                                    <div class="popular-posts">
                                        <h6><a href="innovation-details-mpwalmi.php?id=<?= $a['inno_id'] ?>"><strong><?= $a['title'] ?></strong></a></h6>
