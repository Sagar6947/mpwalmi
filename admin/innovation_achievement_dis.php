    ...
    <main class="app-content">
     <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-cogs"></i>
          <li class="breadcrumb-item"><a  href="innovation_achievement_upload.php" >Add Innovation </a></li>
        </ul>
      </div>
       <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">Innovation And Best Practices</h4>
                                    ...
                                    <th>Description</th>
   				                	<th>Delete</th>
                                        ...
                                        <tbody>
                                              ...
                                              <?php
                                              $i =0;
                                              $c=mysqli_query($con,"SELECT * FROM `innovation` ORDER BY `inno_id` DESC");
                                       while($a=mysqli_fetch_array($c))
										   {
											 ...
											 <tr>					  
												...
												<td><img src="innovation/<?= $a['image'] ?>" ></td>
										<td><?= substr($a['title'],0,50); ?></td>
												
 										<td>
 										    <a class="btn btn-primary" href="innovation_edit.php?id=<?= $a['inno_id'] ?>"> Edit</a>
 										    
 										    <a class="btn btn-danger" href="innovation_achievement_del.php?id=<?= $a['inno_id'] ?>"> Delete</a>
