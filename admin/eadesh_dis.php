...
$c=mysqli_query($con,"SELECT * FROM `eadesh` ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-bell" aria-hidden="true"></i>ई-आदेश  देखें</h1>
          <p>सामग्री डिजाइन प्रेरित कार्ड</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-bell" aria-hidden="true"></i></li>
          <li class="breadcrumb-item"><a class="btn btn-primary" href="eadesh_upload.php" >ई-आदेश  यहां अपलोड करें</a></li>
        </ul>
      </div>
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">ई-आदेश  टेबल्स</h4>
 					...
 					<th>Delete</th>
                                        ...
                                        <tbody>
					                       ...
					                       ' <tr>
                                                ...
                                                <td>'.$a['order_id'].'</td>
                                                  <td>'.$a['subject'].'</td>
                                                  <td> <a class="btn btn--primary btn--rounded" href="img/'.$a['pdf'].'" download> 
                                               Download</a> </td>
												 
                                              	<td>'.$a['date'].'</td>
                                              		<td>'.$a['letter'].'</td>
 												<td><a class="btn btn-primary" href="eadesh-edit.php?id='.$a['id'].'"> Edit</a>
 												<a class="btn btn-danger" href="eadesh_del.php?id='.$a['id'].'"> Delete</a></td>
