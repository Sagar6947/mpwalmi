...
if(!isset($_SESSION['status']))
{
	...
	$e = mysqli_real_escape_string($con, $_POST['description']);
				    ...
				    $qu=mysqli_query($con,"INSERT INTO `adventure_park`(`description`) VALUES ('".$e."' )");
				if ($qu)
				{
...
रोमांच पार्क अपलोड करें</h1>
          <p>यहां
रोमांच पार्क अपलोड करें जो आपकी वेबसाइट में दिखाया जाएगा।</p>
        </div>
