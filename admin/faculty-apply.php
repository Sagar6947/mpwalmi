...
<html lang="en">
  ...
  <title>Faculty Apply | एमपी जल और भूमि प्रबंधन संस्थान, भोपाल</title>
    <meta charset="utf-8">
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-address-book-o"></i>Faculty Apply Form</h1>
       ...
       <div class="row">
                    ...
                    <th>other specialization</th>
                     ...
                     <th>TOT certification</th>
                     <th>Teaching Exp. </th>
                     <th>Training conducted Subject</th>
                     <th>Training level </th>
                     <th>other training lnstitute  </th>
                      <th>Training Methodology </th>
                      <th>Conducted Annually  </th>
					...
					<th>Delete</th>
                                        ...
                                        <tbody>
                                              ...
                                              <?php
                                              $i=0;
                                              $c=mysqli_query($con,"select * from `faculty` order by id desc");
                                                 ...
                                                 
							           {
										$i=$i+1;
										   ...
										   echo  
                                            ...
                                            ' .$a['profession'].'
												...
												<td>'.$a['department'].' </td>
												<td> '.$a['experience'].' Year</td>
												
												
									    
									    
									
												<td>'.$a['specialization_area'].'</td> <td> '.$a['o_specialization'].'</td>
												...
												'.$a['tot_certified'].'</td>
													...
													<td>Exp: '.$a['teach_exp'].'</td>
												<td>'.$a['subject_conducted'].'</td>
												
										<td>'.$a['training_level'].'</td>
										<td>	Other training:'.$a['other_tra'].'</td>
										...
										<td>'.$a['train_ann'].'</td>
											...
											<td>'.$a['award'].'</td>
												...
												<td><a class="btn btn-primary" href="faculty-del.php?id='.$a['id'].'"> Delete</td>
