...
$title= $_POST['title'];
	...
	if(mysqli_query($con, "INSERT INTO `event`(`image`, `title`) 
						   VALUES( '" . $photo . "', '".$title."')")) 
	{
...
<?php include 'header.php'; ?>
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Upload New Event</h3>
            <div class="tile-body">
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="control-label">Event Upload</label>
		   ...
		   <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">Events Display</h4>
                    ...
                    <th>क्रमांक</th>
 					...
 					<th>हटाना</th>
                                        ...
                                        <tbody>
                                              ...
                                              <?php
                                             $c=mysqli_query($con,"select * from event ORDER BY id DESC ");
					                        ...
					                        ' <tr>					  
												...
												<td><img style="height: 60px; width: 60px; display: block;" src="'.$a['image'].'"></td>
 												...
 												<td><a class="btn btn-primary" href="event_del.php?id='.$a['id'].'"> Delete</td>
