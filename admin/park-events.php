  ...
  $c=mysqli_query($con,"select * from park_events ORDER By id DESC");
  ?>
  <!DOCTYPE html>   
  <html lang="en">
  <head>
  ...
  <div class="card">
  <div class="card-body">
  <h4 class="card-title" style="color:#33009F">Ecological park  Events </h4>
...
<td>'.$a['id'].'</td>
  ...
  <td><a class="btn btn-primary" href="park_events_edit.php?id='.$a['id'].'"> Edit</a>
  <a class="btn btn-danger" href="park_events_del.php?id='.$a['id'].'"> Delete</a></td>
