...
if (isset($_POST['upload'])) 
	...
	if(mysqli_query($con, "INSERT INTO `facility` (`category` ) VALUES('" . $a. "' )")) 
	{
            ...
            <div class="tile-body">
              <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <option value="व्याख्यानहॉ"> व्याख्यान कक्ष एवं कांफेंस हॉल</option>
                   ...
                   <option value="मिट्टीपरीक्षणप्रयोगशाला">मिट्टी परीक्षण प्रयोगशाला</option>
                    <option value="सामुदायिकभवन">सामुदायिक भवन</option>
