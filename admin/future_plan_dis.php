...
$c=mysqli_query($con,"select * from future_plan order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-calendar" aria-hidden="true"></i>भविष्य की योजना</h1>
          <p>सामग्री डिजाइन प्रेरित कार्ड</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-calendar" aria-hidden="true"></i>
          <li class="breadcrumb-item"><a  href="future_plan_upload.php" >भविष्य की योजना यहां अपलोड करें</a></li>
        </ul>
      </div>
       <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">भविष्य की योजना टेबल्स</h4>
                     ...
                     <th>विवरण</th>
   					<th>हटाना</th>
                                        ...
                                        <tbody>
					                       ...
					                       ' <tr>					  
                                                <td>'.$a['id'].'</td>
											    <td> <a class="btn btn--primary btn--rounded" href="'.$a['pdf'].'" download> <img style="height: 60px; width: 60px; display: block;" src="../pdf/pdf.png";></a> </td>
											 
												<td>'.substr($a['category'],0,30).'</td>
												<td>'.substr($a['description'],0,60).'</td>
												
 												<td><a class="btn btn-primary" href="program_del.php?id='.$a['id'].'"> Delete</td>
