...
$c=mysqli_query($con,"select * from `gis_training` order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <title>प्रशासनिक समिति :GIS Online Training | एमपी। जल और भूमि प्रबंधन संस्थान, भोपाल</title>
    <meta charset="utf-8">
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-child"></i> GIS online Training</h1>
       ...
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">GIS online Training </h4>
