...
$c=mysqli_query($con,"select * from `form` order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <title>प्रशासनिक समिति ::आवश्यकता फॉर्म| एमपी। जल और भूमि प्रबंधन संस्थान, भोपाल</title>
    <meta charset="utf-8">
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-child"></i> आवश्यकता फॉर्म</h1>
       ...
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">आवश्यकता फॉर्म </h4>
                    ...
                    <th>पद नाम</th>
                     <th>स्थानीय पता</th>
                       <th>मोबाइल</th>
                        <th>ईमेल</th>
                         <th>विशेषज्ञता का क्षेत्</th>
                    <th>योग्यत</th>
					<th>विशिष्ट उपलब्धिया</th>
                    <th> उपयुक्त  जानकारी</th>
                     <th>अनुभव</th>
                    ...
                    <th>हटाना</th>
					   ...
					   ' <tr>					  
												...
												<td><a class="btn btn-primary" href="imp_form_del.php?id='.$a['id'].'"> Delete</td>
