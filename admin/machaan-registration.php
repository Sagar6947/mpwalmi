...
$c=mysqli_query($con,"select * from machaan WHERE `status` ='Book' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <title>Machaan Registration Details</title>
    <meta charset="utf-8">
    ...
    <main class="app-content">
       ...
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">Machaan Registration</h4> 
