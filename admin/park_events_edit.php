...
if(!empty($_FILES['image']['name']))
	...
	if(mysqli_query($con, "UPDATE `park_events` SET `title`='$title',`image`='$folder',`cost`='$cost',`offer_price`='$offer_price',`sdate`='$sdate',
	`edate`='$edate',`description`='$description' WHERE id =".$_GET['id']." ")) 
	{
  ...
  $c=mysqli_query($con,"select * from park_events WHERE id =".$_GET['id']." ");
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <input class="form-control" name="title" type="text" value="<?= $a['title'] ?>" >
                </div>
                <div class="form-group col-sm-4">
                  <label class="control-label">Cost :</label>
                  <input class="form-control" name="cost" type="text" value="<?= $a['cost'] ?>" >
                </div>
                <div class="form-group col-sm-4">
                  <label class="control-label">Offer Price : </label>
                  <input class="form-control" name="offer_price" type="text" value="<?= $a['offer_price'] ?>" >
                </div>
                 <div class="form-group col-sm-4">
                 ...
                 <input name="img" type="hidden" value="<?= $a['image'] ?>" >
                  ...
                  <input class="form-control" name="sdate" type="date" value="<?= $a['sdate'] ?>" >
                </div>
                 <div class="form-group col-sm-4">
                  <label class="control-label">End Date : </label>
                  <input class="form-control" name="edate" type="date" value="<?= $a['edate'] ?>" >
                </div>
                 
                  <div class="form-group col-sm-12">
                  <label class="control-label">Description : </label>
            <textarea name="description" class="form-control" rows="8"><?= $a['description'] ?>
            </textarea>
                 </div>
