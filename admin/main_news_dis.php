...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-newspaper-o" aria-hidden="true"></i>मुख्य समाचार</h1>
          <p>सामग्री डिजाइन प्रेरित कार्ड</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-newspaper-o" aria-hidden="true"></i>
          <li class="breadcrumb-item"><a  href="main_news_upload.php" class="btn btn-primary"> मुख्य समाचार यहां अपलोड करें</a></li>
        </ul>
      </div>
       <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">मुख्य समाचार टेबल्स</h4>
   					...
   					<th>हटाना</th>
                                        ...
                                        <tbody>
					                       ...
					                       ' <tr>					  
												...
												<td><img src="'.$a['pdf'].'" style="height:80px;"></td>
												  
 												<td><a class="btn btn-primary" href="main_news_del.php?id='.$a['id'].'">Delete</td>
