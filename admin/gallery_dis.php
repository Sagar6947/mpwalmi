...
$c=mysqli_query($con,"select * from gallery order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<?php include 'header.php'; ?>
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;गैलरी</h1>
          <p>आपकी सभी अपलोड की गई छवियां यहां दिखायी गयी हैं</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-file-image-o" aria-hidden="true"></i></li>
          <li class="breadcrumb-item"><a class="btn btn-primary" href="gallery_upload.php" >तश्वीरें अपलोड करो</a></li>
        </ul>
      </div>
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">गैलरी टेबल्स</h4>
 					...
 					<th>हटाना</th>
                                        ...
                                        <tbody>
					                        ...
					                        ' <tr>					  
												...
												<td>'.$a['title'].'</td>
                                                 <td>'.$a['category'].'</td>
 												<td><a class="btn btn-primary" href="gallery_del.php?id='.$a['id'].'"> Delete</td>
