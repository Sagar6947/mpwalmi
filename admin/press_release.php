...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-newspaper-o" aria-hidden="true"></i> Press Release </h1>
          <p>सामग्री डिजाइन प्रेरित कार्ड</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-newspaper-o" aria-hidden="true"></i>
          <li class="breadcrumb-item"><a class="btn btn-primary" href="press_release_upload.php" >Press Release  यहां अपलोड करें</a></li>
        </ul>
      </div>
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">Press Release  विवरण टेबल्स</h4>
										  ...
										  echo  
					                       ' <tr>					  
												...
												<td>'.$a['date'].'</td>
 												...
 												<td><a class="btn btn-primary" href="news_del.php?id='.$a['id'].'"> Delete</td>
