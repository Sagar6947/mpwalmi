...
$c=mysqli_query($con,"SELECT * FROM `student` ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <title>प्रशासनिक समिति :: छात्र इंटर्नशिप विवरण | एमपी। जल और भूमि प्रबंधन संस्थान, भोपाल</title>
    <meta charset="utf-8">
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-child"></i> छात्र इंटर्नशिप विवरण </h1>
       ...
       <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">छात्र इंटर्नशिप विवरण </h4>
		...
		<th>नाम</th>
					...
					<th> शैक्षणिक योग्यता विषय</th>
                    <th>इंटर्नशिप  का विषय</th>
                     <th>राशि</th>
                    ...
                    <th>हटाना</th>
					   ...
					   ' <tr>					  
												...
												<td><a class="btn btn-primary" href="student_form_del.php?id='.$a['id'].'"> Delete</td>
