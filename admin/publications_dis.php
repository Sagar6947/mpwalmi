...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-newspaper-o" aria-hidden="true"></i>प्रकाशन</h1>
          <p>सामग्री डिजाइन प्रेरित कार्ड</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-newspaper-o" aria-hidden="true"></i>
          <li class="breadcrumb-item"><a class="btn btn-primary" href="publications_upload.php" >प्रकाशन यहां अपलोड करें</a></li>
        </ul>
      </div>
       <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color:#33009F">कार्यक्रम टेबल्स</h4>
                    ...
                    <th>Image</th>
   					...
   					<th>Delete</th>
                                        ...
                                        <tbody>
					                       ...
					                       ' <tr>					  
                                        <td>'.$a['id'].'</td>
                                        <td>'.substr($a['title'],0,30).'</td>
                                                	
											    <td> <a class="btn btn--primary btn--rounded" href="img/'.$a['pdf'].'" target="_blank">view</a> </td>
											 
											
												<td><img src="img/'.$a['image'].'"style="height:30px;"></td>
												
 												<td><a class="btn btn-primary" href="publications_del.php?id='.$a['id'].'"> Delete</td>
