  ...
  $c=mysqli_query($con,"SELECT * FROM `sport_registration` WHERE `status` ='complete' ORDER By id DESC");
  ?>
  <!DOCTYPE html>   
  <html lang="en">
  <head>
  ...
  <title>वाल्मी मार्च ( चलो वाल्मी जंगल की ओर) | एमपी। जल और भूमि प्रबंधन संस्थान, भोपाल</title>
  <meta charset="utf-8">
  ...
  <div class="app-title">
  <div>
  <h1><i class="fa fa-bell" aria-hidden="true"></i>वाल्मी मार्च ( चलो वाल्मी जंगल की ओर)</h1>

  </div>
  <!--ul class="app-breadcrumb breadcrumb">

  <li class="breadcrumb-item"><a class="btn btn-primary" href="park_events_upload.php" > Upload Ecological park  Events </a></li>
  </ul-->
  </div>
  <div class="row">
  <div class="col-12">
  <div class="card">
  <div class="card-body">
  <h4 class="card-title" style="color:#33009F">वाल्मी मार्च ( चलो वाल्मी जंगल की ओर)</h4>
