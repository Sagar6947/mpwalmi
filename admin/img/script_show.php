...
if($_SESSION['status']!="Active")
{
   ...
   include("config.php");     
$q=mysqli_query($con,"select * from script");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.php">Rang Vidhushak</a>
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    ...
    <div class="row">
         ...
         ' <div class="col-lg-3"><div class="tile">
            <h4 class="tile-title"><p>'.$row['Title'].'</p></h4>
            <div class="tile-body"><img style="height: 200px; width: 100%; display: block;" src="img/pdf.png"'.$row['pdf'].'" alt="Rang Vidhushak"></div>
            <div class="tile-footer"><a class="btn btn-primary" href="Del_script.php?s_id='.$row['s_id'].'">Delete</a></div>
