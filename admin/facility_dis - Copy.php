    ...
    <main class="app-content">
     <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a  href="facility_upload.php" > सुविधा यहां अपलोड करें</a></li>
        </ul>
      </div>
       <div class="row">
   					...
   					<th>हटाना</th>
                                        ...
                                        <tbody>
					                       ...
					                       ' <tr>					  
												...
												<td>'.substr($a['description'],0,150).'</td>
												 <td><a class="btn btn-primary" href="facility_view.php?id='.$a['id'].'">Photo View</a>&nbsp;&nbsp;<a class="btn btn-primary" href="facility_update.php?id='.$a['id'].'">Photo Add</a>&nbsp;&nbsp;<a class="btn btn-primary" href="facility_edit.php?id='.$a['id'].'">Content Add</a></td> 
