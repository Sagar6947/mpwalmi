...
$c=mysqli_query($con,"select * from contact ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <title>प्रशासनिक समिति :: हमसे संपर्क करें | एमपी। जल और भूमि प्रबंधन संस्थान, भोपाल</title>
    <meta charset="utf-8">
...
<?php include 'header.php'; ?>
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><i class="fa fa-address-book-o"></i>  संपर्क देखें</h1>
       ...
       <div class="row">
					...
					<th>हटाना</th>
					   ...
					   ' <tr>					  
												...
												<td><a class="btn btn-primary" href="contact_del.php?id='.$a['id'].'"> Delete</td>
