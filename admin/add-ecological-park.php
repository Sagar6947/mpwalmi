...
if(!isset($_SESSION['status']))
{
	...
	$e = mysqli_real_escape_string($con, $_POST['description']);
				    ...
				    $qu=mysqli_query($con,"INSERT INTO `ecological_park`(`description`) VALUES ('".$e."')");
				if ($qu)
				{
...
पारिस्थितिक पार्क अपलोड करें</h1>
          <p>यहां
पारिस्थितिक पार्क अपलोड करें जो आपकी वेबसाइट में दिखाया जाएगा।</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">
पारिस्थितिक पार्क अपलोड करें</h3>
            <div class="form-group">
              ...
              name="description"  value="" placeholder="कृपया यहां अपना शिलालेख लिखें"></textarea>
                </div>
                <div class="form-group">
