...
if(isset($_GET['id']))
{
	...
	$e = mysqli_real_escape_string($con, $_POST['description']);
				    ...
				    $qu=mysqli_query($con,"UPDATE `ecological_park` SET `description`='".$e."' WHERE  eco_id='$i' ");
				if ($qu)
				{
            ...
            $sqlq=mysqli_query($con,"select * from  `ecological_park` WHERE `eco_id`='$i' ");
