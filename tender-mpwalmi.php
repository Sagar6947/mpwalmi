...
<head>
    ...
    <title>Tender | M.P. Water and Land Management Institute, Bhopal</title>
                            ...
                            <div class="single-blog-text">
                                ...
                                <div class="single-post-text">
                                      ...
                                      <tbody>
                                       <?php
                                       $i=1;
                                       $c=mysqli_query($con,"select * from notice_tender WHERE category = '1' order by id desc");
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align:center;"><?= $i ?></td>
                                          <td><?= wordwrap($a['title'],150, '</br>'); ?></td>
                                           ...
                                           <td style="text-align:center;"> <a  href="admin/<?= $a['pdf'] ?>"  target="_blank" download>  <i class="fa fa-download" aria-hidden="true"></i>
</a> 
                                    </td>   
