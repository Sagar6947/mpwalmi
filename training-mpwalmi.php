...
<head>
    ...
    <title>Training with - M.P. Water and Land Management Institute, Bhopal</title>
...
<body style="background-image: url('assets/images/park/wp3556796.jpg');">
    <div class="main-container">
        ...
        <div class="blog-post blog-post-page grey-bg ">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-padding-y">
                        <div class="blog-box">
                            <div class="blog-img">
                                <img src="assets/img/training.jpg" alt="Training ">
                            </div>
